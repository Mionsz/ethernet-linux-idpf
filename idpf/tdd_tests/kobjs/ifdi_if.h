 ...
 *   /opt/drivers.ethernet.freebsd.common-mevts-attach-detach/common/mock_inc/net/ifdi_if.m
 * with
 *   makeobjops.awk
 *
...
static __inline int
IFDI_ATTACH_POST(if_ctx_t _ctx)
{
	kobjop_t _m;
	int rc;
...
static __inline int
IFDI_REINIT_POST(if_ctx_t _ctx)
{
	kobjop_t _m;
	int rc;
...
static __inline int
IFDI_TX_QUEUES_ALLOC(if_ctx_t _ctx, caddr_t *_vaddrs,
...
static __inline int
IFDI_RX_QUEUES_ALLOC(if_ctx_t _ctx, caddr_t *_vaddrs,
...
IFDI_QUEUES_FREE(if_ctx_t _ctx)
{
	kobjop_t _m;
...
static __inline int
IFDI_MSIX_INTR_ASSIGN(if_ctx_t _sctx, int msix)
{
	kobjop_t _m;
	int rc;
...
static __inline void
IFDI_INTR_ENABLE(if_ctx_t _ctx)
{
	kobjop_t _m;
...
static __inline void
IFDI_INTR_DISABLE(if_ctx_t _ctx)
{
	kobjop_t _m;
...
static __inline int
IFDI_RX_QUEUE_INTR_ENABLE(if_ctx_t _ctx, uint16_t _qid)
{
	kobjop_t _m;
	int rc;
...
static __inline int
IFDI_TX_QUEUE_INTR_ENABLE(if_ctx_t _ctx, uint16_t _qid)
{
	kobjop_t _m;
	int rc;
...
static __inline void
IFDI_LINK_INTR_ENABLE(if_ctx_t _ctx)
{
	kobjop_t _m;
...
/** @brief Unique descriptor for the IFDI_ADMIN_COMPLETION_HANDLE() method */
extern struct kobjop_desc ifdi_admin_completion_handle_desc;
/** @brief A function implementing the IFDI_ADMIN_COMPLETION_HANDLE() method */
typedef void ifdi_admin_completion_handle_t(if_ctx_t _ctx);

static __inline void
IFDI_ADMIN_COMPLETION_HANDLE(if_ctx_t _ctx)
{
	kobjop_t _m;
	KOBJOPLOOKUP(((kobj_t)_ctx)->ops, ifdi_admin_completion_handle);
	((ifdi_admin_completion_handle_t *) _m)(_ctx);
}
...
static __inline int
IFDI_MTU_SET(if_ctx_t _ctx, uint32_t _mtu)
{
	kobjop_t _m;
	int rc;
...
static __inline int
IFDI_PROMISC_SET(if_ctx_t _ctx, int _flags)
{
	kobjop_t _m;
	int rc;
...
static __inline void
IFDI_CRCSTRIP_SET(if_ctx_t _ctx, int _onoff, int _strip)
{
	kobjop_t _m;
...
static __inline void
IFDI_VFLR_HANDLE(if_ctx_t _ctx)
{
	kobjop_t _m;
...
static __inline int
IFDI_IOV_INIT(if_ctx_t _ctx, uint16_t num_vfs,
                                  const nvlist_t * params)
{
	kobjop_t _m;
	int rc;
...
static __inline int
IFDI_IOV_VF_ADD(if_ctx_t _ctx, uint16_t num_vfs,
                                    const nvlist_t * params)
{
	kobjop_t _m;
	int rc;
...
static __inline void
IFDI_UPDATE_ADMIN_STATUS(if_ctx_t _ctx)
{
	kobjop_t _m;
...
static __inline void
IFDI_MEDIA_STATUS(if_ctx_t _ctx, struct ifmediareq *_ifm)
{
	kobjop_t _m;
...
static __inline int
IFDI_MEDIA_CHANGE(if_ctx_t _ctx)
{
	kobjop_t _m;
	int rc;
...
IFDI_GET_COUNTER(if_ctx_t _ctx, ift_counter cnt)
{
	kobjop_t _m;
	uint64_t rc;
...
static __inline int
IFDI_PRIV_IOCTL(if_ctx_t _ctx, u_long _cmd, caddr_t _data)
{
	kobjop_t _m;
	int rc;
...
static __inline int
IFDI_I2C_REQ(if_ctx_t _ctx, struct ifi2creq *_req)
{
	kobjop_t _m;
	int rc;
...
static __inline int
IFDI_TXQ_SETUP(if_ctx_t _ctx, uint32_t _txqid)
{
	kobjop_t _m;
	int rc;
...
static __inline int
IFDI_RXQ_SETUP(if_ctx_t _ctx, uint32_t _txqid)
{
	kobjop_t _m;
	int rc;
...
static __inline void
IFDI_TIMER(if_ctx_t _ctx, uint16_t _txqid)
{
	kobjop_t _m;
...
static __inline void
IFDI_WATCHDOG_RESET(if_ctx_t _ctx)
{
	kobjop_t _m;
...
static __inline void
IFDI_LED_FUNC(if_ctx_t _ctx, int _onoff)
{
	kobjop_t _m;
...
static __inline void
IFDI_VLAN_REGISTER(if_ctx_t _ctx, uint16_t _vtag)
{
	kobjop_t _m;
...
static __inline void
IFDI_VLAN_UNREGISTER(if_ctx_t _ctx, uint16_t _vtag)
{
	kobjop_t _m;
...
static __inline int
IFDI_SYSCTL_INT_DELAY(if_ctx_t _sctx,
...
/** @brief Unique descriptor for the IFDI_NEEDS_RESTART() method */
extern struct kobjop_desc ifdi_needs_restart_desc;
/** @brief A function implementing the IFDI_NEEDS_RESTART() method */
typedef bool ifdi_needs_restart_t(if_ctx_t _ctx,
                                  enum iflib_restart_event _event);

static __inline bool
IFDI_NEEDS_RESTART(if_ctx_t _ctx,
                                        enum iflib_restart_event _event)
{
	kobjop_t _m;
	bool rc;
