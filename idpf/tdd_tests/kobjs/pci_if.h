 ...
 *   /opt/drivers.ethernet.freebsd.common-mevts-attach-detach/common/mock_inc/dev/pci/pci_if.m
 * with
 *   makeobjops.awk
 *
...
PCI_READ_CONFIG(device_t dev, device_t child, int reg,
                                          int width)
{
	kobjop_t _m;
	u_int32_t rc;
...
PCI_WRITE_CONFIG(device_t dev, device_t child, int reg,
                                      u_int32_t val, int width)
{
	kobjop_t _m;
...
static __inline int
PCI_GET_POWERSTATE(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_SET_POWERSTATE(device_t dev, device_t child, int state)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_GET_VPD_IDENT(device_t dev, device_t child,
                                      const char **identptr)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_GET_VPD_READONLY(device_t dev, device_t child,
...
static __inline int
PCI_ENABLE_BUSMASTER(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_DISABLE_BUSMASTER(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_ENABLE_IO(device_t dev, device_t child, int space)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_DISABLE_IO(device_t dev, device_t child, int space)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_ASSIGN_INTERRUPT(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_FIND_CAP(device_t dev, device_t child, int capability,
                                 int *capreg)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_FIND_NEXT_CAP(device_t dev, device_t child,
...
static __inline int
PCI_FIND_EXTCAP(device_t dev, device_t child,
...
static __inline int
PCI_FIND_NEXT_EXTCAP(device_t dev, device_t child,
                                         int capability, int start, int *capreg)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_FIND_HTCAP(device_t dev, device_t child, int capability,
                                   int *capreg)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_FIND_NEXT_HTCAP(device_t dev, device_t child,
                                        int capability, int start, int *capreg)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_ALLOC_MSI(device_t dev, device_t child, int *count)
{
	kobjop_t _m;
	int rc;
...
static __inline void
PCI_ENABLE_MSI(device_t dev, device_t child,
...
static __inline void
PCI_ENABLE_MSIX(device_t dev, device_t child, u_int index,
                                     uint64_t address, uint32_t data)
{
	kobjop_t _m;
...
static __inline void
PCI_DISABLE_MSI(device_t dev, device_t child)
{
	kobjop_t _m;
...
static __inline int
PCI_REMAP_MSIX(device_t dev, device_t child, int count,
                                   const u_int *vectors)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_RELEASE_MSI(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_MSI_COUNT(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_MSIX_COUNT(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_MSIX_PBA_BAR(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_MSIX_TABLE_BAR(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
static __inline int
PCI_GET_ID(device_t dev, device_t child,
...
static __inline struct pci_devinfo *
PCI_ALLOC_DEVINFO(device_t dev)
{
	kobjop_t _m;
...
static __inline void
PCI_CHILD_ADDED(device_t dev, device_t child)
{
	kobjop_t _m;
...
static __inline int
PCI_IOV_ATTACH(device_t dev, device_t child,
...
static __inline int
PCI_IOV_DETACH(device_t dev, device_t child)
{
	kobjop_t _m;
	int rc;
...
PCI_CREATE_IOV_CHILD(device_t bus, device_t pf,
