/* Autogenerated for KSRC=/lib/modules/6.8.0-117-generic/build via kcompat-generator.sh */
...
#define NEED_DEVLINK_PARAMS_VALIDATE_VAL_PTR 1
...
#define HAVE_NDO_GET_TSTAMP 1
#define HAVE_NDO_HWTSTAMP 1
