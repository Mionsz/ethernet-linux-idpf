...
/* Mailbox queues */
#define PF_MBX_BASE			0x08000000

#define PF_MBX_ARQBAL(_i)		(PF_MBX_BASE + ((_i) * 4096))
#define PF_MBX_ARQBAH(_i)		(PF_MBX_BASE + 0x4 + ((_i) * 4096))
#define PF_MBX_ARQLEN(_i)		(PF_MBX_BASE + 0x8 + ((_i) * 4096))
#define PF_MBX_ARQLEN_ARQLEN_S		0
#define PF_MBX_ARQLEN_ARQLEN_M		GENMASK(12, 0)
#define PF_MBX_ARQLEN_ARQVFE_S		28
#define PF_MBX_ARQLEN_ARQVFE_M		BIT(PF_MBX_ARQLEN_ARQVFE_S)
#define PF_MBX_ARQLEN_ARQOVFL_S		29
#define PF_MBX_ARQLEN_ARQOVFL_M		BIT(PF_MBX_ARQLEN_ARQOVFL_S)
#define PF_MBX_ARQLEN_ARQCRIT_S		30
#define PF_MBX_ARQLEN_ARQCRIT_M		BIT(PF_MBX_ARQLEN_ARQCRIT_S)
#define PF_MBX_ARQLEN_ARQENABLE_S	31
#define PF_MBX_ARQLEN_ARQENABLE_M	BIT(PF_MBX_ARQLEN_ARQENABLE_S)
#define PF_MBX_ARQH(_i)			(PF_MBX_BASE + 0xC + ((_i) * 4096))
#define PF_MBX_ARQH_ARQH_S		0
#define PF_MBX_ARQH_ARQH_M		GENMASK(12, 0)
#define PF_MBX_ARQT(_i)			(PF_MBX_BASE + 0x10 + ((_i) * 4096))

#define PF_MBX_ATQBAL(_i)		(PF_MBX_BASE + 0x14 + ((_i) * 4096))
#define PF_MBX_ATQBAH(_i)		(PF_MBX_BASE + 0x18 + ((_i) * 4096))
#define PF_MBX_ATQLEN(_i)		(PF_MBX_BASE + 0x1C + ((_i) * 4096))
#define PF_MBX_ATQLEN_ATQLEN_S		0
#define PF_MBX_ATQLEN_ATQLEN_M		GENMASK(9, 0)
#define PF_MBX_ATQLEN_ATQVFE_S		28
#define PF_MBX_ATQLEN_ATQVFE_M		BIT(PF_MBX_ATQLEN_ATQVFE_S)
#define PF_MBX_ATQLEN_ATQOVFL_S		29
#define PF_MBX_ATQLEN_ATQOVFL_M		BIT(PF_MBX_ATQLEN_ATQOVFL_S)
#define PF_MBX_ATQLEN_ATQCRIT_S		30
#define PF_MBX_ATQLEN_ATQCRIT_M		BIT(PF_MBX_ATQLEN_ATQCRIT_S)
#define PF_MBX_ATQLEN_ATQENABLE_S	31
#define PF_MBX_ATQLEN_ATQENABLE_M	BIT(PF_MBX_ATQLEN_ATQENABLE_S)
#define PF_MBX_ATQH(_i)			(PF_MBX_BASE + 0x20 + ((_i) * 4096))
#define PF_MBX_ATQH_ATQH_S		0
#define PF_MBX_ATQH_ATQH_M		GENMASK(9, 0)
#define PF_MBX_ATQT(_i)			(PF_MBX_BASE + 0x24 + ((_i) * 4096))
